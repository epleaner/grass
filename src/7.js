...
export class GrassScene {
  ...
  createTerrain() {
    ...
    const terrainGeometry = new THREE.PlaneGeometry(400, 400, 300, 300); // Larger, more detailed terrain
    ...
    for (let i = 0; i < this.terrainPos.count; i++) {
      ...
      const bowlBase = Math.pow(distanceFromCenter / 150, 3) * 80; // More dramatic curve
